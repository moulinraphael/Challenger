...
/* *********************************************************/
/* templates/public/login_vp.php ***************************/
/* Template affiché lors de la connexion pour les VP *******/
/* *********************************************************/
...
?>
				...
				<div class="login">
					<form method="post" autocomplete="off">
						<fieldset>
							<legend>Connexion pour les VP aides / sites</legend>
							...
							<center>
								<input type="submit" class="success" name="login_vp" value="Connexion" />
							</center>
						</fieldset>
					</form>
				</div>
