...
if (!empty($_GET['excel']) &&
	...
	$fichier = 'liste_sportifs_ecole_'.onlyLetters(unsecure($sportifs[$_GET['excel']][0]['nom'])).'_groupes';
	...
	$fichier = 'liste_sportifs_ecoles_groupes';
...
require DIR.'templates/admin/competition/sportifs_ecoles_groupes.php';
